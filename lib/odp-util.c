                            ...
                            const struct hmap *portno_names)
{
    static const struct nl_policy ovs_userspace_policy[] = {
        ...
        [OVS_USERSPACE_ATTR_ACTIONS] = { .type = NL_A_UNSPEC,
                                                 .optional = true },
        [OVS_USERSPACE_ATTR_BCAST] = { .type = NL_A_FLAG,
                                       .optional = true },
    };
...
parse_odp_userspace_action(const char *s, struct ofpbuf *actions)
{
    ...
    {
        int n1 = -1;
        if (ovs_scan(&s[n], ",broadcast%n", &n1)) {
            n += n1;
            broadcast = true;
        }
    }
                         ...
                         struct ofpbuf *odp_actions, size_t *odp_actions_ofs)
{
    ...
    if (broadcast) {
        nl_msg_put_flag(odp_actions, OVS_USERSPACE_ATTR_BCAST);
    }
