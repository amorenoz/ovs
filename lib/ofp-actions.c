...
struct nx_action_sample4 {
    ...
    union {
        ...
        ovs_be32 obs_domain_imm;        /* Immediate value for zone. */
    };
              ...
              const struct ofpact_format_params *fp)
{
    ...
    if (a->obs_domain_src.field) {
        ...
        ds_put_format(fp->s, ",%sobs_domain_id=%s%"PRIu32,
                      colors.param, colors.end, a->obs_domain_imm);
    }
    ...
    if (a->obs_point_src.field) {
        ...
        ds_put_format(fp->s, ",%sobs_point_id=%s%"PRIu32,
                      colors.param, colors.end, a->obs_point_imm);
    }
