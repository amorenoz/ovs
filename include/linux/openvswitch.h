...
struct ovs_psample {
	uint32_t group_id;		/* The group used for packet sampling. */
	uint32_t user_cookie_len;	/* The length of the user-provided cookie. */
	uint8_t user_cookie[];		/* The user-provided cookie. */
};
