...
#define HMAP_FOR_EACH_WITH_HASH(NODE, MEMBER, HASH, HMAP)                      \
    for (INIT_CONTAINER_MULTIVAR(NODE, MEMBER,                                 \
                                 hmap_first_with_hash(HMAP, HASH), (void) 0);  \
...
#define HMAP_FOR_EACH_IN_BUCKET(NODE, MEMBER, HASH, HMAP)                       \
    for (INIT_CONTAINER_MULTIVAR(NODE, MEMBER,                                  \
                                 hmap_first_in_bucket(HMAP, HASH), (void) 0);   \
         CONDITION_MULTIVAR(ITER_VAR(NODE) != NULL, NODE, MEMBER);              \
...
#define HMAP_FOR_EACH_INIT(NODE, MEMBER, HMAP, ...)                             \
    for (INIT_CONTAINER_MULTIVAR(NODE, MEMBER, hmap_first(HMAP),                \
                                 __VA_ARGS__);                                  \
         CONDITION_MULTIVAR(ITER_VAR(NODE) != NULL, NODE, MEMBER);              \
