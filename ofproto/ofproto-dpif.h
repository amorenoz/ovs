...
#define DPIF_SUPPORT_FIELDS                                                 \
    ...
    DPIF_SUPPORT_FIELD(bool, add_mpls, "MPLS Label add")                    \
                                                                            \
    /* True if the datapath supports broadcasting flow samples. */          \
    DPIF_SUPPORT_FIELD(bool, bcast_sample, "Broadcast flow samples")
...
bool ovs_broadcast_sample_supported(struct ofproto_dpif *);
